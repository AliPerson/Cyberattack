...
sys.stdout = Logger("DNN/dnn_attack_detector.log")
...
model.save('DNN/dnn_attack_detector_model.h5')
joblib.dump(scaler, 'DNN/dnn_scaler.pkl')
joblib.dump(encoders, 'DNN/dnn_label_encoders.pkl')
...
encoders = joblib.load('DNN/dnn_label_encoders.pkl')
scaler = joblib.load('DNN/dnn_scaler.pkl')
...
model = tf.keras.models.load_model('DNN/dnn_attack_detector_model.h5')
