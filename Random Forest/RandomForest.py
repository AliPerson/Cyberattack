...
sys.stdout = Logger("RF/rf_attack_detector.log")
...
joblib.dump(clf, 'RF/rf_attack_detector_model.pkl')
joblib.dump(scaler, 'RF/rf_scaler.pkl')
joblib.dump(encoders, 'RF/rf_label_encoders.pkl')
...
encoders = joblib.load('RF/rf_label_encoders.pkl')
scaler = joblib.load('RF/rf_scaler.pkl')
...
clf = joblib.load('RF/rf_attack_detector_model.pkl')
